...
export const getUnitOfMeasureController = async (c) => {
    try {
...
export const createUnitOfMeasureController = async (c) => {
...
export const updateUnitOfMeasureController = async (c) => {
    try {
...
export const softDeleteUnifOfMeasureController = async (c) => {
    try {
