...
supplierRoute.post('', validator('json', supplierSchema), createSupplierController);
supplierRoute.put('', validator('json', supplierSchema), updateSupplierController);
supplierRoute.delete('/:supplier_id', softDeleteSupplierController);
