...
export const getEmployeeController = async (c) => {
    try {
...
export const createEmployeeController = async (c) => {
...
export const updateEmployeeController = async (c) => {
    try {
...
export const softDeleteEmployeeController = async (c) => {
    try {
