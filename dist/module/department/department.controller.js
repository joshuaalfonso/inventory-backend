...
export const getDepartmentController = async (c) => {
    try {
...
export const createDepartmentController = async (c) => {
...
export const updateDepartmentController = async (c) => {
    try {
...
export const softDeleteDepartmentController = async (c) => {
    try {
