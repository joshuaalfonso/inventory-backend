...
departmentRoute.post('', validator('json', departmentSchema), createDepartmentController);
departmentRoute.put('', validator('json', departmentSchema), updateDepartmentController);
departmentRoute.delete('/:department_id', softDeleteDepartmentController);
