...
export const getItemTypeController = async (c) => {
    try {
...
export const createItemTypeController = async (c) => {
...
export const updateItemTypeController = async (c) => {
    try {
...
export const softDeleteItemTypeController = async (c) => {
    try {
