...
itemRoute.post('', validator('json', itemSchema), createItemController);
itemRoute.put('', validator('json', itemSchema), updateItemController);
itemRoute.delete('/:item_id', softDeleteItemController);
