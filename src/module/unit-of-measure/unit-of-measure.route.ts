...
unitOfMeasureRoute.post(
    '', 
    validator('json', unitOfMeasureSchema),
    createUnitOfMeasureController
);

unitOfMeasureRoute.put(
    '', 
    validator('json', unitOfMeasureSchema),
    updateUnitOfMeasureController
)

unitOfMeasureRoute.delete(
    '/:unit_of_measure_id',
    softDeleteUnifOfMeasureController
)